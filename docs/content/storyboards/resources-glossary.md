# Storyboard — resources-glossary

(auto-dumped from InstaSafe_Page_Storyboards.xlsx; read this instead of parsing the xlsx)

```
/resources/glossary  —  Zero Trust Glossary
Archetype: A6 RESOURCE   |   Volume 4   |   Every row below is one visible element, top to bottom.
...
2.0 | END VOLUME 4 — CONTENT MASTER SET COMPLETE | 00x GridCards |  | Card grid, swappable media slot | none | dense / grid off | see Component Roles
