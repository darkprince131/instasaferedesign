...
/* ============================================================
   /v2 mirror of the original blue v3 SSO page — preserved
   verbatim during the orange `.iz` migration (see
   app/zero-trust-features/single-sign-on/page.tsx for the new
   canonical page). noindex so this doesn't compete with the
   live URL; canonical points at the main URL, not itself.
   ============================================================ */
...
export default function SsoPageV2() {
  return (
    <>
      <LivingBackground />
      <NavV3 />
