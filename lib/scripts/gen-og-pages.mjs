...
const ALT = {
  ...
  "/zero-trust-network-access":
    "Isometric illustration: a verified user's laptop routes into a ZERO TRUST decision panel " +
    "and on to the permitted estate, while a crossed-out cluster above is captioned NETWORK NOT " +
    "ACCESSIBLE.",
  "/zero-trust-application-access":
    "Isometric illustration: one application console stands lit on its plinth with a single " +
    "route arriving from the left, beneath a greyed, crossed-out cluster captioned NETWORK NOT " +
    "ACCESSIBLE.",
  "/zero-trust-features/device-binding":
    "Isometric illustration: a laptop reading THIS DEVICE with a key sliding into its " +
    "certificate slot, beside a panel listing the MAC address, serial and UUID it is BOUND TO.",
  "/zero-trust-features/device-posture-check":
    ...
    "DEVICE CHECK sheet ticking off operating system, antivirus and disk encryption.",
  ...
  "/instasafe-newsroom":
    "Isometric illustration: an upright InstaSafe NEWSROOM front page with a LATEST badge, a " +
    "lead story and a photo, standing on a plinth in front of two blank sheets.",
  "/blog":
  ...
  "/book-a-demo":
    "Isometric illustration: a SEPTEMBER calendar panel with one date circled in orange and a " +
    "45 MIN footer, a clock beside it, and a laptop reading BOOK A SLOT routed in from the left.",
};
