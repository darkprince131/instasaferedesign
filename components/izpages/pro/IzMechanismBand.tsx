...
/* ============================================================
   IzMechanismBand — the pre-footer banner.

   Sits between the related rail and IzFinalCta, in the slot the
   storyboard reserves for a quiet texture interstitial (15.0
   IzLogTape). The emblem earns that slot better than a log strip:
   it is the only place on the page where the product is stated as
   an OBJECT rather than as a screen, and it is the last thing read
   before the close.

   WHY IT DOESN'T COMPETE WITH IzFinalCta BELOW IT
     - no primary button. One ghost link out to the deep-dive; the
       demand for the demo is made once, in the CTA, not twice.
     - no numbers. Every figure on this page is already stated
       exactly once above (hub rule); a banner that restates 21/12/4
       reads as the page not trusting its own first pass.
